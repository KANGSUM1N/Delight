jQuery('<div class="quantity-nav"><div class="quantity-button quantity-up"><img src="./images/Number1.png" alt=""></div><div class="quantity-button quantity-down"><img src="./images/Number2.png" alt=""></div></div>').insertAfter('.quantity input');
